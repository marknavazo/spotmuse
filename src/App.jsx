    ...
    <ThemeProvider theme={darkTheme}>
      ...
      <AppBar position="static">
        <Toolbar>
          <Typography variant="h6" component={Link} to="/" sx={{ color: 'inherit', textDecoration: 'none', flexGrow: 1 }}>
            ...
            {user ? (
            <>
                <Button color="inherit" component={Link} to="/albums">{t('Álbumes')}</Button>
                <Button color="inherit" component={Link} to="/friends">{t('Amigos')}</Button>
                <Button color="inherit" component={Link} to="/profile">{t('Perfil')}</Button>
              <Button 
                color="inherit" 
      ...
      <Container sx={{ mt: 3 }}>
        <Routes>
          ...
          <Route path="/copilot" element={<ProtectedRoute><CopilotAgents /></ProtectedRoute>} />
        </Routes>
      </Container>
    </ThemeProvider>
  )
